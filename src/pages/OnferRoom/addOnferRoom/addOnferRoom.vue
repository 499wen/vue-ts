    ...
    <div class="form">
      ...
      <div class="form-left">
        <div class="newly-build">
          <div class="form-title">新建会议室</div>
          <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
              <el-form-item label="会议室名称" prop="hotelName">
                <el-input v-model="ruleForm.hotelName" placeholder="请输入会议室名称"></el-input>
              </el-form-item> 
              ...
              <el-form-item label="会议室图片" prop='capacity'>
                <el-upload
              ...
              <el-form-item label="会议室描述">
                <el-input class="textarea" v-model="ruleForm.remark" :autosize="{ minRows: 5, maxRows: 5}" type="textarea" placeholder="请输入会议室描述"></el-input>
              </el-form-item> 
...
<script>
import addOnferRoom from './addOnferRoom'

export default addOnferRoom
</script>

<style scoped lang='less'>
@import url('./addOnferRoom.less');
</style>
